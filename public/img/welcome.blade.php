...
<html lang="en">
  <head>
    ...
    <title>Software 3 — TheSaaS Sample Demo Landing Page</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-auto col-lg-5 text-right">
            <a class="btn btn-sm btn-round btn-outline-success d-none d-lg-inline-block mr-2" href="#">Sign in</a>
            <a class="btn btn-sm btn-round btn-success" href="#">Sign up</a>
          </div>
      ...
      <div class="container text-center">
        <div class="row align-items-center h-100">
          ...
          <div class="col-md-8 mx-auto">
            <h1>Boost productivity with TheSaaS Business</h1>
            <p class="lead mt-4 mb-7">The secure file sharing and storage solution that employees and IT admins trust.</p>
            <a class="btn btn-xl btn-round btn-primary px-8" href="#">Try For Free</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="row gap-y align-items-center">
            ...
            <div class="col-md-4 mx-auto text-center">
              <img class="border shadow-7" src="../assets/img/preview/shot-3.png" alt="..." data-aos="fade-right">
            </div>


            <div class="col-md-4 mx-auto">
              <h3>The best way to work together</h3>
      ...
      <section class="section overflow-hidden">
        <div class="container-fluid">
          <div class="row gap-y align-items-center">
            ...
            <div class="col-md-4 mx-auto text-center">
              <img class="border shadow-7" src="../assets/img/preview/shot-2.png" alt="..." data-aos="fade-left">
            </div>


            <div class="col-md-4 mx-auto order-md-first">
              <h3>Enterprise-ready performance and controls</h3>
      ...
      <section class="section bg-gray overflow-hidden">
        <div class="container-fluid">
          <div class="row gap-y align-items-center">
            ...
            <div class="col-md-4 mx-auto text-center">
              <img class="border shadow-7" src="../assets/img/preview/shot-4.png" alt="..." data-aos="fade-right">
            </div>
