                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="numbers">
                                    <p class="card-category">Memos</p>
                                    <h4 class="card-title">{{ $memos->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fresh-datatables">
                        <table id="bootstrap-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td><a href="{{ route('memos.show', $memo->id) }}">M00{{ $memo->id }}</a></td>
                                    <td>{{ $memo->subject }}</td>
                                    <td>{{ $memo->property->property_name }}</td>
                                    <td>{{ $memo->to }}</td>
                                    <td>{{ $memo->from }}</td>
                                    <td>{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $memo->date)->format('Y-m-d')  }}</td>
                                    <td></td>
                                </tr>
                                @endforeach
