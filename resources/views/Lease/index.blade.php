                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="numbers">
                                    <p class="card-category">Outstanding Lease Balances</p>
                                    <h4 class="card-title">{{ $leases->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card data-tables">
                <div class="card-header ">
                    <h4 class="card-title"> Outstanding Lease Balances</h4>
                    ...
                    <div class="fresh-datatables">
                        <table id="bootstrap-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td><a href="{{ route('leases.show', $lease->id) }}">L00{{ $lease->id }}</a></td>
                                    <td><a href="#" >{{ $lease->tenant->property->property_name }}</a>
                                    </td>

                                    <td><a href="">{{ $lease->tenant->full_name }}</a></td>
